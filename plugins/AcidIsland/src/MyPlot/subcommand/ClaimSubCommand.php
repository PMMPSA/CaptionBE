...
class ClaimSubCommand extends SubCommand
{
    ...
    public function execute(CommandSender $sender, array $args) {
        ...
        if ($this->getPlugin()->getProvider()->savePlot($plot)) {
			...
			$player->getInventory()->addItem(Item::get(8, 0, 2));//nuoc
			$player->getInventory()->addItem(Item::get(85, 0, 2));//hang rao
            ...
            $sender->sendMessage("§9[§bLavaIsland§9] §aĐã Thêm§b Nước§a Và§6 Hàng rào§a Vào Kho Đồ Của Bạn");
            $sender->sendMessage("§9[§bLavaIsland§9]§c Hãy cẩn với lava");
        } else {
