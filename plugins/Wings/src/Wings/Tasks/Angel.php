...
class Angel extends Task{
  ...
  $x = $p->getX();
	  ...
	  $level->addParticle(new HeartParticle(new Vector3( $x, $y+2, $x),  80, 100, 0, 1));
       ...
       $level->addParticle(new FlameParticle(new Vector3( $x-0.5, $y, $z)));
        $level->addParticle(new FlameParticle(new Vector3( $x-0.3, $y, $z)));
          $level->addParticle(new FlameParticle(new Vector3( $x-1.3, $y, $z)));
          $level->addParticle(new FlameParticle(new Vector3( $x-0.8, $y, $z)));
            $level->addParticle(new FlameParticle(new Vector3( $x, $y, $z-0.3)));
            $level->addParticle(new FlameParticle(new Vector3( $x, $y, $z-0.5)));
             $level->addParticle(new FlameParticle(new Vector3( $x, $y, $z-0.8)));
             $level->addParticle(new FlameParticle(new Vector3( $x, $y, $z-1.3)));
       ...
       $level->addParticle(new FlameParticle(new Vector3( $x+0.5, $y, $z)));
        $level->addParticle(new FlameParticle(new Vector3( $x+0.3, $y, $z)));
           ...
           $level->addParticle(new FlameParticle(new Vector3( $x, $y, $z+1.3)));
          //X
          $level->addParticle(new FlameParticle(new Vector3( $x+0.3, $y, $z-0.3)));
           $level->addParticle(new FlameParticle(new Vector3( $x+0.5, $y, $z-0.5)));
          $level->addParticle(new FlameParticle(new Vector3( $x+0.8, $y, $z-0.8)));
          $level->addParticle(new FlameParticle(new Vector3( $x+1, $y, $z-1)));
          $level->addParticle(new FlameParticle(new Vector3( $x+1.3, $y, $z-1.3)));
          //
          $level->addParticle(new FlameParticle(new Vector3( $x-0.3, $y, $z-0.3)));
           $level->addParticle(new FlameParticle(new Vector3( $x-0.5, $y, $z-0.5)));
          $level->addParticle(new FlameParticle(new Vector3( $x-0.8, $y, $z-0.8)));
	 ...
	 $level->addParticle(new FlameParticle(new Vector3( $x, $y+0.8, $z)));
